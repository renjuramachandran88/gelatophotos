...
import com.gelatotest.data.repository.PhotoDataRepository
...
open class AppModuleForTest {
    ...
    @Provides
    fun providesPhotoListService(library: DataLibrary): PhotoListService =
        library.photoListService()

    @Provides
    fun providesPhotoRepository(photoDataRepository: PhotoDataRepository): PhotoRepository = photoDataRepository
